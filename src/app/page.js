...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 font-inter">
      ...
      {/* CTA Section */}
      <section className="py-20 sm:py-40 bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-700 relative overflow-hidden">
        <div className="absolute inset-0">
        ...
        <div className="absolute top-0 left-0 w-full h-full">
          <div className="absolute top-10 sm:top-20 left-10 sm:left-20 w-48 h-48 sm:w-64 sm:h-64 bg-gradient-to-r from-white/10 to-yellow-300/10 rounded-full blur-3xl animate-pulse"></div>
          <div className="absolute bottom-10 sm:bottom-20 right-10 sm:right-20 w-56 h-56 sm:w-80 sm:h-80 bg-gradient-to-r from-white/5 to-pink-300/5 rounded-full blur-3xl animate-pulse delay-1000"></div>
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 sm:w-96 sm:h-96 bg-gradient-to-r from-white/5 to-cyan-300/5 rounded-full blur-3xl animate-pulse delay-500"></div>
          {/* Floating Icons */}
          <div className="absolute top-20 sm:top-32 left-1/4 animate-bounce delay-700 hidden sm:block">
          ...
          <div className="absolute bottom-20 sm:bottom-32 right-1/4 animate-bounce delay-300 hidden sm:block">
            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-yellow-400/30 rounded-lg sm:rounded-xl flex items-center justify-center backdrop-blur-sm">
        ...
        <div className="container mx-auto px-4 sm:px-6 text-center relative">
          <div className="max-w-4xl mx-auto space-y-6 sm:space-y-8">
            <div className="inline-flex items-center px-4 sm:px-6 py-2 sm:py-3 bg-white/20 backdrop-blur-sm rounded-full text-white text-xs sm:text-sm font-semibold tracking-wide mb-6 sm:mb-8">
              {t('landing.cta.badge')}
            </div>
            
            <h2 className="text-xl sm:text-2xl lg:text-4xl font-bold text-white mb-4 sm:mb-6 leading-tight">
              {t('landing.cta.title1')}
              <span className="block bg-gradient-to-r from-yellow-300 to-orange-300 bg-clip-text text-transparent">{t('landing.cta.title2')}</span>
            </h2>
            
            <p className="text-base sm:text-lg lg:text-xl text-blue-100 mb-6 sm:mb-8 max-w-2xl mx-auto leading-relaxed">
              {t('landing.cta.description')}<span className="text-yellow-300 font-semibold">{t('landing.cta.shopOwners')}</span>{t('landing.cta.descriptionEnd')}
            </p>
            
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center">
              <Link href="/setup">
                <button className="group w-full sm:w-auto bg-white text-blue-600 px-6 sm:px-8 py-3 sm:py-4 rounded-xl text-sm sm:text-base font-bold hover:bg-blue-50 transition-all duration-300 flex items-center justify-center cursor-pointer shadow-xl hover:shadow-white/25 transform hover:-translate-y-1 hover:scale-105 min-h-[48px]">
                  {t('landing.cta.startFreeSetup')}
                  <svg className="ml-2 h-4 w-4 sm:h-5 sm:w-5 group-hover:translate-x-1 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
                  </svg>
                </button>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12 pt-12 border-t border-white/20">
              <div className="text-center">
                ...
                <div className="text-blue-200 text-sm">{t('landing.cta.socialProof.businesses')}</div>
              </div>
              <div className="text-center">
                <div className="text-xl lg:text-2xl font-bold text-white mb-1">50hrs</div>
                <div className="text-blue-200 text-sm">{t('landing.cta.socialProof.timeSaved')}</div>
              </div>
              <div className="text-center">
                <div className="text-xl lg:text-2xl font-bold text-white mb-1">24/7</div>
                <div className="text-blue-200 text-sm">{t('landing.cta.socialProof.support')}</div>
              </div>
            </div>
          </div>
        </div>
